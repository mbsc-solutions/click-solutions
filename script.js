...
const data=stored||fallback,p=data.profile||fallback.profile;
...
["topWhatsApp","heroWhatsApp","bottomWhatsApp"].forEach(id=>{const e=document.getElementById(id);if(e)e.href=waLink();});
